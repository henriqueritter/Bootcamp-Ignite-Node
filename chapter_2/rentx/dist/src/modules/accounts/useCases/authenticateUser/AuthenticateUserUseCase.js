...
var auth_1 = __importDefault(require("@config/auth")); // infos para o token
...
var AuthenticateUserUseCase = /** @class */ (function () {
    ...
    AuthenticateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordMatch, token, refresh_token, refresh_token_expires_date, tokenReturn;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        refresh_token_expires_date = this.dateProvider.addDays(auth_1.default.expires_refresh_token_days);
