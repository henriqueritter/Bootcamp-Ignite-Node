...
var bcrypt_1 = require("bcrypt"); // para cryptografar a senha
var tsyringe_1 = require("tsyringe");
var AppError_1 = require("@shared/errors/AppError");
var ResetPasswordUserUseCase = /** @class */ (function () {
    function ResetPasswordUserUseCase(usersTokensRepository, usersRepository, dateProvider) {
    ...
    ResetPasswordUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userToken, dateNow, isTokenExpired, user, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        isTokenExpired = this.dateProvider.compareIfBefore(userToken.expires_date, dateNow);
