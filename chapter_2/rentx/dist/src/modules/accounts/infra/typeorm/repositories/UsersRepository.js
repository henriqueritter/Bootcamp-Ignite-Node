...
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var name, password, email, driver_license, id, avatar, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = data.name, password = data.password, email = data.email, driver_license = data.driver_license, id = data.id, avatar = data.avatar;
