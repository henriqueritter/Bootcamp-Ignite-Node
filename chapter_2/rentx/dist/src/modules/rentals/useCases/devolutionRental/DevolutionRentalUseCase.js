...
var DevolutionRentalUseCase = /** @class */ (function () {
    ...
    DevolutionRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var rental, minimum_daily, car, dateNow, daily, rentalDelay, total, calculate_fine;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (rental.user_id != user_id) {
                            throw new AppError_1.AppError("Rental does not belong to this user.");
                        }
                        return [4 /*yield*/, this.carsRepository.findById(rental.car_id)];
                    case 2:
                        car = _b.sent();
                        dateNow = this.dateProvider.dateNow();
                        daily = this.dateProvider.compareInDays({
                        ...
                        rentalDelay = this.dateProvider.compareInDays({
                            start_date: dateNow,
                        ...
                        if (rentalDelay > 0) {
                            calculate_fine = rentalDelay * car.fine_amount;
