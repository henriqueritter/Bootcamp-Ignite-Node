...
describe("Create Category Controller", function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent(); // cria connection
                    return [4 /*yield*/, connection.runMigrations()];
                case 2:
                    _a.sent(); // executa as migrations
                    id = uuid_1.v4();
    ...
    it("should be albe to create a new category", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("it should not be albe to create a new category with name exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app).post("/sessions").send({
