...
var CarsRepositoryInMemory = /** @class */ (function () {
    ...
    CarsRepositoryInMemory.prototype.create = function (_a) {
        var name = _a.name, description = _a.description, daily_rate = _a.daily_rate, category_id = _a.category_id, brand = _a.brand, fine_amount = _a.fine_amount, license_plate = _a.license_plate, specifications = _a.specifications, id = _a.id;
