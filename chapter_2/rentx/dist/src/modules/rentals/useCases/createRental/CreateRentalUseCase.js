...
var CreateRentalUseCase = /** @class */ (function () {
    ...
    CreateRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var minimumRentHour, carUnavailable, rentalOpenToUser, dateNow, compare, rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (rentalOpenToUser) {
                            throw new AppError_1.AppError("There is already a rental in progress for user.");
                        }
                        dateNow = this.dateProvider.dateNow();
                        compare = this.dateProvider.compareInHours({
                            start_date: dateNow,
