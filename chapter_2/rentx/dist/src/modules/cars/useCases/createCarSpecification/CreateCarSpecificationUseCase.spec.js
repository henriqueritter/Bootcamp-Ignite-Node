...
describe("Create Car Specification", function () {
    ...
    it("should not be able to create add a new specification to a non-existent car", function () { return __awaiter(void 0, void 0, void 0, function () {
        var car_id, specifications_id;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    car_id = "1234";
                    specifications_id = ["8989", "9090"];
                    return [4 /*yield*/, expect(createCarSpecificationUseCase.execute({
                            car_id: car_id,
                            specifications_id: specifications_id,
                        })).rejects.toEqual(new AppError_1.AppError("Car doest not exists."))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("should be able to create add a new specification to the car", function () { return __awaiter(void 0, void 0, void 0, function () {
